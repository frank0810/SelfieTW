...
const SingleTaskPreview = ({ task, onTaskUpdate, onTaskDelete }) => {
    ...
    const handleModalClose = () => {
        setShowModal(false);
        setEditedTask({ ...task }); // Reset dei cambiamenti non salvati
        setError('');
    };
    ...
    return (
        <>
            <ListGroup.Item className="mb-3">
                ...
                <div className="mb-2">
                    <span className="badge bg-info me-2">✅ Attività</span>
                </div>
                ...
                <Row className="mb-3">
                    <Col>
                        <div className="mb-2">
                            ...
                            <strong>Scadenza:</strong> {new Date(task.deadline).toLocaleDateString('it-IT')}
                        </div>
