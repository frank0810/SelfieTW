  ...
  return (
    <div id="timer-div">
      ...
      {currentCycle + 1 !== cicles ? (
        <button className="pomodoro-button" onClick={handleNextTimer}>Passa alla prossima fase</button>
      ) : (<p></p>)}
      <button className="pomodoro-button" onClick={reloadPage}>Termina Ciclo</button>
      <button className="pomodoro-button" onClick={restartCycle}>Ricomincia Ciclo</button>
